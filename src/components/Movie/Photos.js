...
import { selectPhotos } from "../../features/movies/singleMovieSlice";
import { getNumber, navigatingSlider } from "../../helpers/helpers";
...
const Photos = () => {
  ...
  return (
    <section>
      <MovieSectionTitle count={images.length} moreInfo={true}>
        Photos
      </MovieSectionTitle>
      <section
