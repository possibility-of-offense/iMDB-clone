...
import classes from "./styles/SingleMoviePageSubNav.module.css";

// REFACTOR

const SingleMoviePageSubNav = ({ link }) => {
  return (
    <section className={classes["subnav"]}>
      <ul>
        <li>
          <Link to={link}>Cast &amp; Crew</Link>
        </li>
        <li>
          <svg
            width="24"
...
export default SingleMoviePageSubNav;
